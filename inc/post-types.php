...
function custom_post_type_careers()
{
	...
	$labels = array(
		'name'                  => _x('Careers', 'Post Type General Name', 'simple-pest'),
		'singular_name'         => _x('Career', 'Post Type Singular Name', 'simple-pest'),
		'menu_name'             => __('Careers', 'simple-pest'),
		'name_admin_bar'        => __('Careers', 'simple-pest'),
		'archives'              => __('Careers Archives', 'simple-pest'),
		'attributes'            => __('Career Attributes', 'simple-pest'),
		'parent_item_colon'     => __('Parent Career:', 'simple-pest'),
		'all_items'             => __('All Careers', 'simple-pest'),
		'add_new_item'          => __('Add New Career', 'simple-pest'),
		'add_new'               => __('Add Career', 'simple-pest'),
		'new_item'              => __('New Career', 'simple-pest'),
		'edit_item'             => __('Edit Career', 'simple-pest'),
		'update_item'           => __('Update Career', 'simple-pest'),
		'view_item'             => __('View Career', 'simple-pest'),
		'view_items'            => __('View Careers', 'simple-pest'),
		'search_items'          => __('Search Career', 'simple-pest'),
		'not_found'             => __('Not found', 'simple-pest'),
		'not_found_in_trash'    => __('Not found in Trash', 'simple-pest'),
		'featured_image'        => __('Featured Image', 'simple-pest'),
		'set_featured_image'    => __('Set featured image', 'simple-pest'),
		'remove_featured_image' => __('Remove featured image', 'simple-pest'),
		'use_featured_image'    => __('Use as featured image', 'simple-pest'),
		'insert_into_item'      => __('Insert into Career', 'simple-pest'),
		'uploaded_to_this_item' => __('Uploaded to this Career', 'simple-pest'),
		'items_list'            => __('Careers list', 'simple-pest'),
		'items_list_navigation' => __('Careers list navigation', 'simple-pest'),
		'filter_items_list'     => __('Filter Careers', 'simple-pest'),
	);
	$args = array(
		'label'                 => __('Career', 'simple-pest'),
		'description'           => __('Simple Pest Management careers', 'simple-pest'),
		'labels'                => $labels,
		'supports'              => array('title', 'editor', 'thumbnail', 'excerpt'),
		//'taxonomies'            => array( 'category', 'post_tag' ),
		'hierarchical'          => false,
