                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Safety Data Sheet</th>
                    ...
                    <tr>
                        ...
                        <td><a href="<?php echo $sheet['url']; ?>" target="_blank">Safety Data Sheet</a></td>
                        <td><a href="<?php echo $label['url']; ?>" target="_blank">Label</a></td>
                    </tr>
                    <?php endwhile; ?>
                </table>
                <?php endif; ?>
